...
public class Book {
    ...
    private short getMoveFromKey(long searchKey) {
        ...
        LinkedList<Short> potentialMoves = new LinkedList<>();
        /* Stores the weights for the moves of the position */
        LinkedList<Short> potentialMoveWeights = new LinkedList<>();
        ...
        try {
            ...
            Notification.getInstance().getLogger().error("Error while reading book");
            return -1;
        }
     ...
     */
    private short selectMove(LinkedList<Short> moves, LinkedList<Short> weights, int weightSum) {
